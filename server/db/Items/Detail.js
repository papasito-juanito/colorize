const query = `
SELECT i.id item_id, ic.itemPhoto photo, b.brandName brand, i.itemName item, i.itemPrice price, i.itemVolume volume, i.itemDetail description, r1.count 1star, r2.count 2star, r3.count 3star, r4.count 4star, r5.count 5star, rt.count total, r.rating average
