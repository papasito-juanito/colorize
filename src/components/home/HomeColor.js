...
function sortColorGroup(dbItemHex) {
  ...
  // console.log('unsorted hArr: ' + hArr);
  hArr.sort(function(a, b){
    return a-b;
  });
  // console.log('sorted hArr: ' + hArr);
  var splitArr = Math.round(hArr.length/8);
  // console.log('splitArr: ' + splitArr);

  //ranges
  // console.log('A ' + hArr[0], hArr[splitArr-1]);
  // console.log('B ' + hArr[splitArr-1], hArr[splitArr*2-1]);
  // console.log('C ' + hArr[splitArr*2-1], hArr[splitArr*3-1]);
  // console.log('D ' + hArr[splitArr*3-1], hArr[splitArr*4-1]);
  // console.log('E ' + hArr[splitArr*4-1], hArr[splitArr*5-1]);
  // console.log('F ' + hArr[splitArr*5-1], hArr[splitArr*6-1]);
  // console.log('G ' + hArr[splitArr*6-1], hArr[splitArr*7-1]);
...
// console.log(Object.keys(colorGroup));
